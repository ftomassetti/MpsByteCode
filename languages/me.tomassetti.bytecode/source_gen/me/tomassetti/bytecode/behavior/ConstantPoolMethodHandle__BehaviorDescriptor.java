...
public final class ConstantPoolMethodHandle__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x1392eb99581d482bL, 0xaa2819e40eaffbe2L, 0x1695a3631a43d9c5L, "me.tomassetti.bytecode.structure.ConstantPoolMethodHandle");
  ...
  /*package*/ static ConstantPoolElementType tag_id1qlCQcqgXe2(@NotNull SNode __thisNode__) {
    return ConstantPoolElementType.CONSTANT_MethodHandle;
  }
  /*package*/ static void serializeInfo_id6cFMhcmFVC0(@NotNull SNode __thisNode__, MyDataOStream mds) {
    mds.write1Byte((long) Unsigned1Byte__BehaviorDescriptor.toLong_id6cFMhcmG8L8.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x1392eb99581d482bL, 0xaa2819e40eaffbe2L, 0x1695a3631a43d9c5L, 0x67eeae9702c890ddL, "referenceKind"))));
    mds.write2Bytes((long) Unsigned2Bytes__BehaviorDescriptor.toLong_id1qlCQcqjgik.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x1392eb99581d482bL, 0xaa2819e40eaffbe2L, 0x1695a3631a43d9c5L, 0x67eeae9702c890dfL, "referenceIndex"))));
  }

  /*package*/ ConstantPoolMethodHandle__BehaviorDescriptor() {
    super(REGISTRY);
  }
