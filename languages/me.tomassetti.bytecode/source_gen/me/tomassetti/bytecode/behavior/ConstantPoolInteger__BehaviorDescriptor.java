...
public final class ConstantPoolInteger__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x1392eb99581d482bL, 0xaa2819e40eaffbe2L, 0x1695a3631a43d9c6L, "me.tomassetti.bytecode.structure.ConstantPoolInteger");
  ...
  /*package*/ static void serializeInfo_id6cFMhcmFVC0(@NotNull SNode __thisNode__, MyDataOStream mds) {
    mds.write4Bytes(Unsigned4Bytes__BehaviorDescriptor.asBigInteger_id1kVJV2AbFR5.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x1392eb99581d482bL, 0xaa2819e40eaffbe2L, 0x1695a3631a43d9c6L, 0x67eeae9702c86079L, "bytes"))));
  }

  /*package*/ ConstantPoolInteger__BehaviorDescriptor() {
    super(REGISTRY);
  }
